...
def str_byte(a):
    ...
    byte = ["0", "0", "0", "0", "0000"]
    while a >= 4096:
        if ((byte[2] != "a") or (byte[2] != "b") or (byte[2] != "c") or (byte[2] != "d")
                or (byte[2] != "e") or (byte[2] != "9")):
        ...
        a -= 4096
    while a >= 256:
        if ((byte[3] != "a") or (byte[3] != "b") or (byte[3] != "c") or (byte[3] != "d") or
                (byte[3] != "e") or (byte[3] != "9")):
        ...
        a -= 256
    while a >= 16:
        if ((byte[0] != "a") or (byte[0] != "b") or (byte[0] != "c") or
                (byte[0] != "d") or (byte[0] != "e") or (byte[0] != "9")):
        ...
        a -= 16
    while a >= 1:
        if ((byte[1] != "a") or (byte[1] != "b") or (byte[1] != "c") or
                (byte[1] != "d") or (byte[1] != "e") or (byte[1] != "9")):
